...
<div id="sidebar" class="col-md-4">
    ...
    <div class="recent-post-container">
        ...
        <?php 
                    ...
                    $sql = "SELECT p.post_id,p.title,p.post_date,p.category,p.post_img,c.category_name
                            FROM post p 
                            LEFT JOIN category c ON p.category = c.category_id
                            ORDER BY p.post_id DESC LIMIT {$limit} ";
                      
                    $result = mysqli_query($conn, $sql) or die("Query Failed. Recent Post : " .mysqli_error($conn));
